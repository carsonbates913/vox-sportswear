        ...
        return (
            <div className="navbar">
                ...
                <svg className="vox-logo-svg" width="186" height="68" viewBox="0 0 186 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M92.5444 0.229693L92.5443 0.229409L1.56376 33.4875L1.56465 33.49L0 34.0595L0.00057229 34.061L1.45721 34.5912L1.45824 34.5908L92.5503 67.8933L92.551 67.8912L92.8499 68L93.1487 67.8912L93.1488 67.8915L184.234 34.595L184.233 34.59L185.689 34.0599L184.233 33.5297L184.233 33.5293L93.1428 0.227605L93.1421 0.229672L92.8433 0.120911L92.5444 0.229693ZM182.779 34.0624L92.846 1.18383L2.91449 34.0585L92.8471 66.9371L182.779 34.0624Z" fill="#01683E"/>
                    </svg>
                </NavLink>
                <div className="navbar-right-container">
                    <NavLink className="inactive" activeclassname="active" to="/aboutus">About</NavLink>
                    <NavLink className="inactive" activeclassname="active" to="/products">Products</NavLink>
                    <NavLink className="inactive navbar-cart-button" activeclassname="active" to="/mycart">
                        Cart
                            {cartProducts.length > 0 && (cartProducts.length < 10 ? (<div className="cart-length-container">{cartProducts.length}</div>) : (<div className="cart-length-container">9+</div>) ) }
                    </NavLink>
